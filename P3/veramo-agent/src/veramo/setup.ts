...
// API KEY
const INFURA_API_KEY = '7f0fd16c271848ce9ff76beab5d51ecc'

// Secret key for KMS
const KMS_SECRET_KEY = 'ab227e965b278e631d60511558b03604ac51a08500468fd5953024ab26581486'
  ...
  plugins: [
    ...
    new DIDResolverPlugin({
      resolver: new Resolver({
        ...ethrDidResolver({ infuraProjectId: INFURA_API_KEY }),
        ...webDidResolver(),
      }),
    }),
  ],
